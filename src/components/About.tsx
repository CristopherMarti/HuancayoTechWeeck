...
export function About() {
  return (
    <section className="w-full bg-[#f0f0f0] py-24 md:py-32 relative overflow-hidden z-20 border-b-[6px] border-black">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, #000 2px, transparent 0)', backgroundSize: '32px 32px' }}></div>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex justify-center pointer-events-none opacity-5">
        <h2 className="text-[120px] md:text-[200px] lg:text-[280px] font-black font-display text-black uppercase tracking-tighter whitespace-nowrap leading-none">
          TECHWEEK
        </h2>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10 flex flex-col md:flex-row gap-12 items-center justify-between relative z-10">
        ...
        <div className="w-full md:w-2/3 flex flex-col items-start text-left bg-white border-[6px] border-black p-8 md:p-12 shadow-[16px_16px_0px_0px_#000]">
          ...
          <motion.h2 
            ...
            className="text-3xl md:text-5xl lg:text-6xl font-black font-display text-black leading-tight uppercase tracking-tighter"
          >
            ¿Qué es el <span className="text-transparent bg-clip-text bg-gradient-to-r from-black to-black" style={{ WebkitTextStroke: '2px black', color: 'white' }}>Techweek?</span>
            <br />Una semana de eventos en Huancayo.
          </motion.h2>
          <p className="mt-6 text-xl md:text-2xl font-bold text-black/80 max-w-2xl">
