    ...
    >
      <div className="flex flex-col items-start mb-16 md:mb-24 max-w-4xl">
        ...
        >
          ...
          <span className="text-black font-black text-sm uppercase tracking-widest">Hosts</span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="font-display font-black text-6xl md:text-8xl text-black uppercase tracking-tighter mb-8 leading-none bg-[#74D724] px-6 py-4 border-[6px] border-black shadow-[12px_12px_0px_0px_#000]"
        >
          ...
          >
            ...
            <div className="flex-1 p-6 md:p-8 flex flex-col bg-[#f0f0f0]">
              <div className="flex items-center gap-2 mb-4">
                <span className="px-4 py-1.5 bg-black text-white text-xs font-black uppercase tracking-widest border-2 border-black">
                  {host.type}
                </span>
              ...
              <h3 className="font-display font-black text-3xl md:text-5xl text-black mb-3 uppercase tracking-tight line-clamp-1">
                {host.name}
              </h3>

              <p className="text-black font-bold text-base md:text-lg max-w-md line-clamp-2">
                {host.desc}
              </p>
            </div>
          </motion.div>
      ...
      >
        <div className="relative z-10 md:w-2/3 text-left">
          <h2 className="font-display font-black text-4xl md:text-6xl text-white uppercase tracking-tight mb-4" style={{ WebkitTextStroke: '2px black' }}>
            Abre tus puertas
          </h2>
          <p className="text-black font-bold text-lg md:text-2xl max-w-xl bg-white/80 p-4 border-4 border-black">
        ...
        <div className="relative z-10 md:w-1/3 flex justify-end w-full">
          <button className="w-full md:w-auto bg-white text-black border-[4px] border-black font-black text-xl md:text-2xl py-4 px-8 flex items-center justify-center gap-3 transition-all hover:bg-black hover:text-white shadow-[6px_6px_0px_0px_#000] hover:translate-x-1 hover:translate-y-1 hover:shadow-none group uppercase tracking-widest">
            Aplicar ahora
